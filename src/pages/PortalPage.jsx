export const PORTALS = [
  { role:"student",            label:"Student",             tagline:"Apply for forms, track approvals",       icon:"🎓", color:"#e85d26", bg:"#fff5f0", border:"#fcd9c4", desc:"Leave, certificates, placement, hostel, activity forms and more",   demo:{email:"student@college.edu",pass:"student123"},     canRegister:true  },
  { role:"faculty",            label:"Faculty",             tagline:"Apply for leave, research & admin forms", icon:"👨‍🏫", color:"#059669", bg:"#f0fdf4", border:"#a7f3d0", desc:"Leave, FDP, conference, lab requests, travel allowance and more",   demo:{email:"faculty@college.edu",pass:"faculty123"},     canRegister:true  },
  { role:"mentor",             label:"Mentor",              tagline:"Review & approve student applications",   icon:"🧑‍💼", color:"#2563eb", bg:"#eff6ff", border:"#bfdbfe", desc:"First-level approvals for assigned students across all form types", demo:{email:"mentor@college.edu",pass:"mentor123"},       canRegister:true  },
  { role:"hod",                label:"Head of Department",  tagline:"Department-level approvals & reports",   icon:"🏛️", color:"#7c3aed", bg:"#f5f3ff", border:"#ddd6fe", desc:"Approve department applications, view reports and student tracker", demo:{email:"hod@college.edu",pass:"hod123"},              canRegister:true  },
  { role:"college_admin",      label:"College Admin",       tagline:"Manage forms, users & analytics",        icon:"⚙️", color:"#374151", bg:"#f9fafb", border:"#d1d5db", desc:"Full control: form templates, user management, all applications",   demo:{email:"admin@college.edu",pass:"admin123"},          canRegister:false },
  { role:"placement_director", label:"Placement Director",  tagline:"Manage placement documents",             icon:"💼", color:"#f59e0b", bg:"#fffbeb", border:"#fde68a", desc:"Internship NOC, placement registration, industrial visit approvals", demo:{email:"placement@college.edu",pass:"placement123"}, canRegister:false },
  { role:"college_director",   label:"College Director",    tagline:"Final authority — all approvals",        icon:"👔", color:"#0d1b2a", bg:"#f1f5f9", border:"#cbd5e1", desc:"Final sign-off on all escalated applications from every department", demo:{email:"director@college.edu",pass:"director123"},   canRegister:false },
];
